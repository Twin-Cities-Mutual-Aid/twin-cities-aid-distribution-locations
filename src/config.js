const { SNOWPACK_PUBLIC_MAPBOXGL_ACCESS_TOKEN, SNOWPACK_PUBLIC_DATA_URL, SNOWPACK_PUBLIC_TRANSLATION_URL, TRACK_JS_TOKEN} = import.meta.env
...
export default {
  ...
  trackJsToken: ensure("TRACK_JS_TOKEN", TRACK_JS_TOKEN)
}
